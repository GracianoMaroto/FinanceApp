...
import { adicionarDespesa, buscarDespesas, deletarDespesa } from 'src/services/despesasService'
...
const date = ref(null)
const opçoes = ["Crédito", "Débito", "Pix"]
...
<div class="col-12">
    <q-btn label="Adicionar Despesa" color="dark" type="submit" />
    <q-btn label="Limpar Campos" color="dark" outline class="q-ml-sm" type="reset" />
</div>
</q-form>
</div>
